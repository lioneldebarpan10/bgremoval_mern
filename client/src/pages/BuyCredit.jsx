...
const BuyCredit = () => {
   return (
      <div className='min-h-[80vh] text-center pt-14 mb-10'>
         ...
         <h1 className='text-center text-2xl md:text-3xL lg:text-4xl font-semibold mt-4 bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent mb-6 sm:mb-10'>Choose the plan that’s right for you</h1>
         <div className='flex flex-wrap justify-center gap-6  text-left'>
            ...
            {plans.map((item, index) => (
               <div key = {index} className='bg-white drop-shadow-sm rounded-lg py-12 px-8 tet-gray-700 hover:scale-105 transition-all duration-500'>
                  ...
                  <button className='w-full bg-gray-800 text-white mt-8 text-sm py-2.5 rounded-md min-w-52 cursor-pointer'>Purchase</button>
               </div>
